...
<link rel="stylesheet" href="{{asset('css/themes/krajee-fa/theme.css')}}" media="all" type="text/css"/>
		...
		<div class="col-md-4 single-right-left ">
			<div class="grid images_3_of_2">
				<div class="flexslider">
					<ul class="slides">
						<li data-thumb="{{asset('images_product')}}/{{$single['image']}}">
							<div class="thumb-image"> <img src="{{asset('images_product')}}/{{$single['image']}}" data-imagezoom="true" class="img-responsive"> </div>
						</li>
						@foreach ($single['images'] as  $val)
						<li data-thumb="{{asset('images_product')}}/{{$val['name']}}">
							<div class="thumb-image"> <img src="{{asset('images_product')}}/{{$val['name']}}" data-imagezoom="true" class="img-responsive"> </div>
						</li>
						@endforeach
					</ul>
				...
				<div class="product-shoe-info shoe">
					<div class="men-pro-item">
						<div class="men-thumb-item">
							<img src="{{asset('images_product')}}/<?=$value['image']?>">
...
<script src="{{asset('css/themes/krajee-fa/theme.js')}}" type="text/javascript"></script>
<script src="{{asset('css/themes/krajee-svg/theme.js')}}" type="text/javascript"></script>
<script src="{{asset('css/themes/krajee-uni/theme.js')}}" type="text/javascript"></script>
@endsection
@stop
